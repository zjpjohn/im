...
public class TestSync {
	...
	static {
		try {
			...
			mapper.addMappedClass(Fans.class);
			mapper.addMappedClass(Friends.class);
			mapper.addMappedClass(UserCollect.class);
	...
	public static void list() {
		List<User> userList = ds.find(User.class).asList();

		for (User user : userList) {
			System.out.println(user.getUserId() + "\t" + user.getCreateTime() + "\t" + user.getNickname());
		}
		// 100830 100831 100832 100827 0
