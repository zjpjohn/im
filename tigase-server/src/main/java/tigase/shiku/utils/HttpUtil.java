...
public final class HttpUtil {
	...
	public static class Request {
		...
		public Request(Map<String, Object> data, RequestMethod method,
				String spec) {
			super();
			this.data = data;
			this.method = method;
	...
	public static <T> T asBean(Request request, Class<?> clazz)
			throws Exception {
	...
	public static <T> T asBean(Map<String, Object> data, String spec,
