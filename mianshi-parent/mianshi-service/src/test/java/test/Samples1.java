...
import cn.xyz.commons.parser.AbstractResumeParser;
...
public class Samples1 {
	...
	static {
		morphia = new Morphia();
		morphia.mapPackage("com.shiku.mianshi.vo", true);
		try {
	...
	public static void main(String[] args) throws Exception {
		...
		FileInputStream in = new FileInputStream("C:\\Users\\Administrator\\Desktop\\陶文聪.mht");
		ResumeV2 resume = AbstractResumeParser.newReader(1, in).read();
	...
	public static BasicDBObject newDBObject(Object... kvs) {
		if (0 != kvs.length % 2)
			throw new RuntimeException("可变参数长度为只能为偶数");
